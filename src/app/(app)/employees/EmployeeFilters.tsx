...
export function EmployeeFilters() {
  ...
  const handleRoleChange = (value: string) => {
    setLoading(true);
    startTransition(() => {
      router.push(buildUrl({ role: value }));
    });
  };
  ...
  const handleJobStatusChange = (value: string) => {
    setLoading(true);
    startTransition(() => {
      router.push(buildUrl({ jobStatus: value }));
    });
  };
  ...
  const hasActiveFilters = search || role !== "all" || jobStatus !== "all";
  ...
  const jobStatusOptions = [
    { value: "all", label: "All" },
    { value: "active", label: "Has Active Jobs" },
    { value: "completed", label: "Has Completed Jobs" },
    { value: "unpaid", label: "Has Unpaid Jobs" },
  ];
